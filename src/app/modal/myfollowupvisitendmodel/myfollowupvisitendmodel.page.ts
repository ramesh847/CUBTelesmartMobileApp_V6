...
export class MyfollowupvisitendmodelPage implements OnInit {
  ...
  ispgroup:boolean=false;
  iscustomerid:boolean=false;
  islead:boolean=false
  isremark:boolean=true
  ishidecheckbox:boolean=true
  ishidelocation:boolean=true
  ...
  crdit_facility: any;
  type: any;
  ispremiumpayterm: boolean=false;
  ispremiumpaymode: boolean=false;
  ispremimumamt: boolean=false;
  isfreeincome: boolean=false;
...
this.getbusinessunit1(this.followupvisits.customerid);
...
this.calloutcome()
  ...
  if(this.followupvisits.crdit_facility==2){
    ...
    // this.followupvisits.crdit_facility=this.followupvisits.crdit_facility
    this.isfollowupdate=false
    this.islead=false
    this.isremark=true
  }
...
getprod
  ...
  calltypeChange(){
    debugger
   if( this.followupvisits.calltype=='T'){
     this.ishidecheckbox=false
     this.ishidelocation=false
   }else{
  ...
  onproduct(){
debugger
if(this.followupvisits.type=='Insurance'){
  this.isfollowupdate=false
 
this.ispremiumpayterm=true
this.ispremiumpaymode=true
this.ispremimumamt=true
this.isfreeincome=true
this.isopendate=true
this.iscrosssell=true
this.issourcelead=true
this.isrefered=true
this.ishidecheckbox=true
this.ishidelocation=true
this.isremark=true
...
} else if(this.followupvisits.type=='Banking'){
  this.iscustomerid=true
  this.islead=true
} else if(this.followupvisits.type=='Product Listing'){
  this.islead=true
  this.isproduct=true
} else if(this.followupvisits.type=='Others'){
  this.ispgroup=true
  this.isproduct=true
  this.isfollowupdate=false
  this.islead=true
  this.ispremiumpayterm=false
  this.ispremiumpaymode=false
  this.ispremimumamt=false
  this.isfreeincome=false
  this.isopendate=false
  this.iscrosssell=false
  this.issourcelead=false
   ...
   this.Apiservice.getbusinesstype(cust)
      .then((response:any)=> {
       ...
       let respo = JSON.parse(response.data);
        this.businessunit =JSON.parse(respo);
       // this.hidespin();
...
this.followupvisits={};
  ...
  calloutcome(){
    ...
    this.Apiservice.calloutcomeapi().then((res:any)=>{
      debugger
      this.callout= JSON.parse(JSON.parse(res.data))
    })
  }
  checkboxClick(e:any){
    debugger
...
//   this.search.CUSTOMER_ID = "";
  ...
  this.Apiservice.myfollowupvisitsdata(this.branchid, this.userid, this.usertype,this.purpose,this.customerid)
    .then((response:any)=> {
      debugger
     // this.hidespin();
     this. responseout = JSON.parse(JSON.parse(response.data));
...
debugger
  ...
  this.Apiservice.getInsuranceType()
    .then((response:any)=> {
      debugger
      console.log(response.data);
     this.ins_type = JSON.parse(JSON.parse(response.data));
    })
...
this.Apiservice.getInsuranceSource()
    .then((response:any)=> {
      debugger
      console.log(response.data);
      this.ins_source = JSON.parse(JSON.parse(response.data));
    })
}
getInsurancedata(){
debugger
    ...
    // this.showspin();
      this.Apiservice.getcustomerdetails(txtId)
        .then((response:any)=> {
         ...
         this.followupvisitscustomerdata = JSON.parse(response.data);
          //console.log(this.followupvisitscustomerdata)
          if(this.followupvisitscustomerdata.length != 0)
          {
          ...
          .then((response:any) =>{
            debugger
            console.log(response)
           this.vaildResp= JSON.parse(response.data)
          // this.hidespin($ionicLoading);
